...
project = 'qetch'
copyright = ("2018, {__author__}").format(**PACKAGE)
...
# # NOTE: enable if using 'alabaster'
#
# html_theme_options = {
#     'description': 'A framework for extracting and downloading content from various sites.',
